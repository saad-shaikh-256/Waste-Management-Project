  ...
  return (
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-6 py-12">
        <div className="grid md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-4">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Get the latest on sustainability and platform news.
            </p>
            <form>
              <div className="flex">
                <input
                  ...
                  className="w-full px-4 py-2 text-gray-800 bg-gray-200 rounded-l-md focus:outline-none focus:ring-2 focus:ring-green-500"
                />
                <button
                  type="submit"
                  className="bg-green-500 text-white font-semibold px-4 rounded-r-md hover:bg-green-600 transition-colors"
                >
                  Go
                </button>
              </div>
        ...
        <div className="mt-12 border-t border-gray-800 pt-6 flex flex-col sm:flex-row justify-between items-center text-sm">
